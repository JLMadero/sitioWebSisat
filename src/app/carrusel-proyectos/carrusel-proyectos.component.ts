...
@Component({
  ...
  animations: [
    trigger('fadeInOut', [
      transition(':enter', [ style({ opacity: 0 }), animate('1000ms ease-in', style({ opacity: 1 })) ]),
...
soluciones = [
  ...
  { label: 'Control de fluidos', link: 'soluciones/fluidos', img: 'assets/imgs/sisat.svg', desc: 'Gestión y control de combustible.' },
  { label: 'Rastreo satelital', link: 'soluciones/rastreo', img: 'assets/imgs/rastreo.svg', desc: 'Ubicación precisa y segura.' },
  { label: 'App móvil', link: 'soluciones/app', img: 'assets/imgs/app.svg', desc: 'Control total desde tu celular.' },
  { label: 'Última milla', link: 'soluciones/ultima-milla', img: 'assets/imgs/sisat.svg', desc: 'Eficiencia en la entrega final.' },
